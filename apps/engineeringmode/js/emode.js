...
var EMode = {
  ...
  init: function ut_init(evt) {
    // Set functional test for nightly debug. 
    this.testClass = window.location.hash.split('#')[1] || 'functional-test';
  ...
  updateMainTitle: function em_updateMainTitle() {
    var total = this.testList.querySelectorAll('li:not([hidden])').length;
